...
export const handleDataAuth = async (res: any, loader: HTMLElement | null, text: HTMLElement | null, { toast }: Props, reset: any, navigate: NavigateFunction, msg="Data added successfully") => {
  try {
    if (loader) {
      loader.style.display = 'none';
    }
